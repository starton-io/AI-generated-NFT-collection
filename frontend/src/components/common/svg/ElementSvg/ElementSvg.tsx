...
export const ElementSvg: React.FC<ElementSvgProps> = (props) => {
	return (
	<SvgIcon width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g clipPath="url(#a)">
			<path fillRule="evenodd" clipRule="evenodd" d="M21.953 19.607V9.63l6.586-3.503v9.818l-6.586 3.663z" fill="url(#b)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m17.727 23.171.07 8.43-.235.131-8.863-4.87v-3.69h9.028z" fill="url(#c)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M21.954 24.349v4.948l-4.392 2.435V24.35h4.392z" fill="url(#d)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m13.25 17.076.004.002-.165 4.947 2.258 1.253-8.846 4.919-.13-.075-.035-9.744 9.027-5.088v2.536l-2.113 1.25z" fill="url(#e)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M6.505 18.373 0 14.767V9.82l6.678 3.54-.173 5.014z" fill="url(#f)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m30.735 17.122-8.782 4.71v5.107l8.782-4.87v-4.947z" fill="url(#g)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m2.113 15.866 4.392 2.514v9.819l-4.392-2.514v-9.819z" fill="#29F6A8"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M13.09 22.027v-4.948l.061-.038 8.801 4.794v5.107l-8.862-4.915z" fill="url(#h)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M8.866 14.644 0 9.819l8.866-4.825v9.65z" fill="url(#i)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m30.737 17.122-8.781 4.87-8.866-4.918 2.28-1.269-.018.01 2.212 1.227 4.349-2.42.043-2.37 8.78 4.87z" fill="url(#j)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m15.367 13.451.002-.001-.107.059-4.354-2.373L8.7 12.421V2.436l.293-.163 8.735 5.032-.058 9.73-.107.089-2.211-1.307.016-2.366z" fill="url(#k)"/>
			<path fill="url(#l)" d="M12.105 5.942h17.844v15.003H12.105z"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M17.565 17.093V7.305l-.096-.053 4.444-2.405.041.022v9.782l-4.39 2.442z" fill="url(#m)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m15.369 13.45-8.866 4.93-4.39-2.514 8.795-4.89 4.46 2.474z" fill="url(#n)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M21.953 9.788V4.87l2.196-1.256 4.391 2.514-6.587 3.661z" fill="url(#o)"/>
			<path fillRule="evenodd" clipRule="evenodd" d="m8.7 2.436 8.862 4.869 4.391-2.436L13.09 0 8.7 2.436z" fill="#76FF0B"/>
		</g>
		<defs>
